const SingleSell = ({ item }) => {
  return (
    <li className='text-left my-5'>
      ...
      <button className='bg-red-500 hover:bg-red-700 text-white text-center py-2 px-4 rounded'>
        Delete
      </button>
      <button className='bg-gray-500 hover:bg-gray-700 text-white text-center py-2 px-4 rounded'>
        Edit
      </button>
      <button className='bg-green-500 hover:bg-green-700 text-white text-center py-2 px-4 rounded'>
        Save
      </button>
    </li>
  );
